export const idlFactory = ({ IDL }) => {
  ...
  const LegacyArchiveInfo = IDL.Record({
  ...
  const Token = IDL.Service({
    ...
    'icrc106_get_index_principal' : IDL.Func([], [Icrc106GetResult], ['query']),
    'icrc107_get_fee_collector' : IDL.Func(
        [],
        [GetFeeCollectorResult],
        ['query'],
      ),
    'icrc107_set_fee_collector' : IDL.Func(
        [SetFeeCollectorArgs],
