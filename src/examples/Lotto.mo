...
///
/// This token uses the base sample token but adds functions that are called once a transfer occurs.
...
///
/// The only changes to the base code are the registration of a tokens_transferred_listener in the ICRC1 class. Supporting infrastructure can be found at the end of the actor file. 
///
/////////////////////
